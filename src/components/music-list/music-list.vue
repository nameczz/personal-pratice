<template>
    <div class="music-list">
        ...
        <div class="bg-image" ref="bgImage" @click="random">
        ...
        <scroll class="list" ref="list" :data="songs" :probe-type="probeType" :listen-scroll="listernScroll" @scroll="scroll">
...
export default {
    ...
    methods: {
        ...
        selectItem(song, index) {
            // 设置 playlist / sequenceList / fullscreen.... 多个commit 封装成action
            this.selectPlay({
                list: this.songs,
                index: index
            })
