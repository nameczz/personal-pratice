				...
				<div class="bottom">
					...
					<div class="progress-wrapper">
						...
						<div class="progress-bar-wrapper">
							<progress-bar @percentChanges="onProgressBarChange" :percent="percent"></progress-bar>
						</div>
...
import anmations from 'create-keyframe-animation'
...
export default {
	...
	methods: {
		...
		enter(el, done) {
			...
			anmations.runAnimation(this.$refs.cdWrapper, 'move', done)
		},
		afterEnter() {
			anmations.registerAnimation('move')
		...
		_getPosAndScale() {
			...
			const x = -(window.innerWidth / 2 - paddingLeft) // 右移为负数
